...
class AdminController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        $resellerId = 1;
        $companyId = 1;
        $Orders = $this->orderRepository->getOrderCountByStatus($resellerId, $companyId);
        ...
        $countCustomers = $this->countCustomers($resellerId, $companyId);
     ...
     * @throws \Doctrine\ORM\NonUniqueResultException
     */
    protected function countCustomers($resellerId = null, $companyId = null)
    {
        ...
        if ($resellerId !== null) {
            $qb->andWhere('c.reseller_id = :resellerId')
